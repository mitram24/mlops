...
def test_clean_data_drops_null_targets_and_keeps_ids_for_group_split(raw_df):
    ...
    # Identifier columns are kept until data_split can use player_api_id for grouping.
